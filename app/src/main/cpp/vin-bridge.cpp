...
#include "qtoken-cpp/include/nodes/node.hpp"
#include "qtoken-cpp/include/globals/logger.hpp"
#include "qtoken-cpp/include/globals/config.hpp"
...
extern "C" {
    ...
    Java_com_virgilsystems_qtoken_QToken_get(JNIEnv *env, jclass clazz, jstring key) {
        try {
            ...
            vector<unsigned char> msg_vector = pNode->doGet(key_str);
...
//            char* msg_char_array = &msg_vector[0];
    ...
    */
    ...
    Java_com_virgilsystems_qtoken_QToken_spread(JNIEnv *env, jclass clazz, jstring file_path) {
        ...
        auto receipt = pNode->doSpread(file_path_str);
    ...
    Java_com_virgilsystems_qtoken_QToken_gather(JNIEnv *env, jclass clazz) {
        ...
        auto ch = pNode->doGather(test_file);
